...
class GirlMetadata(models.Model):
    ...
    language          = models.ForeignKey(Language)
    description       = models.CharField(max_length=1024, blank=True, help_text="Descripcion de la actriz")
...
class SerieMetadata(models.Model):
    ...
    summary_short     = models.CharField(max_length=512, blank=True, help_text="Descripcion corta")
